...
together_api_key=""
judge_model_path="/workspace/Hyperguard_diffusion/hf_models/Meta-Llama-3-8B-Instruct"
...
cd /workspace/Hyperguard_diffusion/run_alpaca
...
attack_prompt="/workspace/Hyperguard_diffusion/run_alpaca/refine_prompt/alpaca_data_refined_${version}.json"
output_json="/workspace/Hyperguard_diffusion/run_alpaca/attack_results/${model_name}_${attack_method}_attack_${defense_method}_defense_${version}.json"
save_path="/workspace/Hyperguard_diffusion/run_alpaca/eval_results/eval_results_${model_name}_${attack_method}_attack_${defense_method}_defense_${version}.json"
