...
cd /workspace/Hyperguard_diffusion/run_strongreject || { echo "Failed to change directory"; exit 1; }
...
attack_prompt="/workspace/Hyperguard_diffusion/run_strongreject/refine_prompt/strongreject_data_refined_${version}.json"
output_json="/workspace/Hyperguard_diffusion/run_strongreject/attack_results/${model_name}_${attack_method}_attack_${defense_method}_defense_${version}.json"
...
save_path="/workspace/Hyperguard_diffusion/run_strongreject/eval_results/eval_results_${model_name}_${attack_method}_attack_${defense_method}_defense_${version}.json"
evaluator_path="/workspace/Hyperguard_diffusion/hf_models/strongreject-15k-v1"
...
# harmfulness_save_path="/workspace/Hyperguard_diffusion/run_strongreject/eval_results/harmfulness_score/${model_name}_${attack_method}_${defense_method}_${version}.json"
