...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate responses using LLaDA Instruct model on AdvBench")
...
def generate_response(vanilla_prompt, prompt, tokenizer, model, args) -> str:
...
def main():
    ...
    with torch.no_grad():
        for item in tqdm(data, desc="Processing AdvBench", total=len(data)):
            # AdvBench fields: goal, target, refined goal
