...
\twocolumn[
%%% STUDENTS: FILL IN WITH YOUR OWN INFORMATION
\dlaititle{HyperGuard: Hyperbolic Trajectory Monitoring for Early Jailbreak Detection in Diffusion Language Models}

\begin{center}\today\end{center}

\begin{dlaiauthorlist}
\dlaiauthor{Riccardo Bastiani}{sap}
\dlaiauthor{Murad Hüseynov}{sap}
\dlaiauthor{Sara Lazzaroni}{sap}
\end{dlaiauthorlist}

%%% STUDENTS: FILL IN WITH YOUR OWN INFORMATION
\dlaiaffiliation{sap}{Sapienza University of Rome}
\dlaicorrespondingauthor{Sara Lazzaroni}{lazzaroni.1983548@studenti.uniroma1.it}
